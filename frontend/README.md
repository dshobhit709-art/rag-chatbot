...
This project is maintained by Shobhit Dixit.

About the Developer:
Shobhit Dixit is an AI/ML Engineer with 4 years of experience building and deploying production-grade machine learning and generative AI systems. He specializes in transformer models, real-time inference architectures, and LLM-powered RAG systems, with a focus on optimizing end-to-end ML pipelines.
